...
<body>
    ...
    <div class="topbar">
        <div class="topbar-inner">
            <div class="top-left">
                <div class="burger" onclick="window.location.href='{{ route('login') }}'" style="cursor: pointer;">☰
                </div>
                <img src="{{ asset('img/Guia_Repsol.png') }}" class="logo" alt="Guía Repsol">
                <div class="logo" onclick="window.location.href='{{ route('login') }}'" style="cursor: pointer;">
                </div>
                <nav class="nav">
                    <a href="{{ route('pre-login') }}" class="enlace">Comer</a>
                    <a href="{{ route('pre-login') }}" class="enlace">Viajar</a>
                    <a href="{{ route('pre-login') }}" class="enlace">Soles</a>
                    <a href="{{ route('pre-login') }}" class="enlace active">Soletes</a>
                </nav>
            </div>
            <div class="top-right" onclick="window.location.href='{{ route('pre-login') }}'" style="cursor: pointer;">🔍
                Acceso</div>
        </div>
    </div>
    ...
    <section class="subnav">
        <div class="subnav-inner">
            ...
            <div onclick="window.location.href='{{ route('login') }}'" style="cursor: pointer;">Donde comen los
                cocineros</div>
        </div>
    </section>
    ...
    <section class="que-son">
        <div class="que-son-inner">
            ...
            <div class="categorias">
                ...
                <div class="categoria" onclick="window.location.href='{{ route('login') }}'"
    ...
    <section class="cercanos">
        <div class="cercanos-box">
            ...
            <div class="cercanos-header">
                ...
                <button class="location-btn" onclick="window.location.href='{{ route('login') }}'">📍 Activar
                    ubicación</button>
            </div>

            <!-- FILTROS -->
            <div class="cercanos-filters">
                <button class="filter-pill" onclick="window.location.href='{{ route('login') }}'">🍽 Tipo de local
                    ▾</button>
                <button class="filter-pill" onclick="window.location.href='{{ route('login') }}'">€ Precio ▾</button>
                <button class="filter-pill" onclick="window.location.href='{{ route('login') }}'">🍴 Comida
                    ▾</button>
                <button class="filter-pill active" onclick="window.location.href='{{ route('login') }}'">1 Solete
                    ▾</button>
            </div>
            ...
            <div class="cercanos-dots">
                <span class="dot active" onclick="window.location.href='{{ route('login') }}'"
                    style="cursor: pointer;"></span>
                <span class="dot" onclick="window.location.href='{{ route('login') }}'"
                    style="cursor: pointer;"></span>
                <span class="dot" onclick="window.location.href='{{ route('login') }}'"
                    style="cursor: pointer;"></span>
                <span class="dot" onclick="window.location.href='{{ route('login') }}'"
        ...
        <div class="app-box">
            ...
            <div class="app-mockup">
                <div class="phone">
                    ...
                    <!-- CARDS FLOTANTES -->
                    <div class="float-card left" onclick="window.location.href='{{ route('login') }}'"
                        style="cursor: pointer;">
                        <span>🍳</span>
                        <p>¿Unas tostadas mañaneras?</p>
                    </div>

                    <div class="float-card center" onclick="window.location.href='{{ route('login') }}'"
                        style="cursor: pointer;">
                        <span>📍</span>
                        <p>Haz una reserva<br>en el sitio</p>
                    </div>

                    <div class="float-card right" onclick="window.location.href='{{ route('login') }}'"
                        style="cursor: pointer;">
                        <span>📅</span>
    ...
    <footer class="footer">
        ...
        <div class="footer-newsletter">
            <div class="footer-newsletter-inner">
                ...
                <form class="newsletter-form"
                    onsubmit="event.preventDefault(); window.location.href='{{ route('login') }}';">
        ...
        <div class="footer-main">
            <div class="footer-main-inner">
                ...
                <div class="footer-brand" onclick="window.location.href='{{ route('login') }}'"
                    style="cursor: pointer;">
